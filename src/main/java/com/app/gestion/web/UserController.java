...
import com.app.gestion.dao.RoleRepository;
import com.app.gestion.dao.UserRepository;
import com.app.gestion.dao.UserRolesRepository;
import com.app.gestion.entities.Role;
import com.app.gestion.entities.User;
import com.app.gestion.entities.UsersRoles;
...
//		Page<User> users = usrRep.findAll(new PageRequest(p, s));
		Page<UsersRoles> users = urlRep.findAll(PageRequest.of(s, p));
